...
pub(super) fn synthesize_typed_dict_method<'db>(
    ...
    match method_name {
        ...
        "items" if !typed_dict.openness(db).is_open() => Some(synthesize_typed_dict_view_method(
            db,
            typed_dict,
            "dict_items",
        )),
        "keys" if !typed_dict.openness(db).is_open() => Some(synthesize_typed_dict_view_method(
            db,
            typed_dict,
            "dict_keys",
        )),
        "values" if !typed_dict.openness(db).is_open() => Some(synthesize_typed_dict_view_method(
            db,
            typed_dict,
            "dict_values",
        )),
